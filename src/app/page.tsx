...
import { Plus, Pencil, Trash2, Check, X, Calendar, ChevronDown, Home, BarChart3, ListChecks, User } from "lucide-react";
				...
				<div className="flex-1 flex flex-col gap-8">
					{activeTab === "home" && (
						<>
							...
							<div className="flex flex-col gap-4 max-h-[400px] overflow-y-auto pr-3 custom-scrollbar">
								{WEEK_DAYS.map((day) => {
					...
					{activeTab === "stats" && (
						<div className="flex-1 flex flex-col items-center justify-center py-20 gap-4 opacity-50">
							...
							<p className="text-sm font-bold text-white uppercase tracking-widest">Stats coming soon</p>
						</div>
					)}
					...
					{activeTab === "list" && (
						<div className="flex-1 flex flex-col items-center justify-center py-20 gap-4 opacity-50">
							...
							<p className="text-sm font-bold text-white uppercase tracking-widest">Habit List Coming soon</p>
						</div>
					)}
					...
					{activeTab === "profile" && (
						<div className="flex-1 flex flex-col items-center justify-center py-20 gap-4 opacity-50">
							...
							<p className="text-sm font-bold text-white uppercase tracking-widest">Profile coming soon</p>
						</div>
					)}
				</div>

				{/* Bottom Tab Bar */}
				<nav className="mt-auto bg-white/5 rounded-3xl p-2 border border-white/10 flex items-center justify-between shadow-lg">
					{[
						{ id: "home", icon: Home, label: "홈" },
						{ id: "stats", icon: BarChart3, label: "통계" },
						{ id: "list", icon: ListChecks, label: "습관목록" },
						...
						return (
							...
							>
								<Icon size={20} strokeWidth={isActive ? 3 : 2} className={cn(isActive && "neon-glow")} />
								<span className={cn(
